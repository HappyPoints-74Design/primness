...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Drawer = function () {
    function Drawer(element) {
      ...
      this.pageOverlayElement = document.querySelector('.PageOverlay-custom');
    ...
    _createClass(Drawer, [{
      key: 'destroy',
      value: function destroy() {
        this.delegateBody.off('click', '[data-action="open-drawer"][data-drawer-custom-id="' + this.element.id + '"]');
        this.delegateBody.off('click', '[data-action="close-drawer"][data-drawer-custom-id="' + this.element.id + '"]');
      ...
      value: function _attachListeners() {
        ...
        this.delegateBody.on('click', '[data-action="open-drawer"][data-drawer-custom-id="' + this.element.id + '"]', this._openListener);
        this.delegateBody.on('click', '[data-action="close-drawer"][data-drawer-custom-id="' + this.element.id + '"]', this._closeListener);
  ...
  var ProductVariants = function () {
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _onVariantChanged(previousVariant, newVariant) {
        ...
        // this._selectCallback(newVariant);
    ...
    {
      key: '_selectCallback',
      value: function _selectCallback(variant) {
        if (variant && variant.available) {
          document.getElementById('BIS_trigger').style.display = 'none'; // hide the button
        } else {
          document.getElementById('BIS_trigger').setAttribute('data-variant-id', variant.id);
          document.getElementById('BIS_trigger').style.display = 'block'; // show the button and set the default variant
        }
      }
    },
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_6__components_ProductVariants__ = __webpack_require__(11);
  var CollectionSection = function () {
    function CollectionSection(element) {
      ...
      this.products = this.element.querySelectorAll('.ProductItem');
      this.products.forEach(function(product) {
        var options = JSON.parse(product.getAttribute('data-section-settings'));
        if (options['templateSuffix'] !== 'coming-soon') {
          product.productVariants = new __WEBPACK_IMPORTED_MODULE_6__components_ProductVariants__["default"](product, options);
        }
      })
    ...
    _createClass(CollectionSection, [{
      ...
      value: function _toggleTag(event) {
        ...
        let height =  document.querySelector('.collection-filters__heading').offsetHeight;
        document.querySelector('.collection-filters__panels').style.top = height + 'px';
    ...
    {
      key: '_clearTag',
      value: function _clearTag(event) {
        var element = event.target;
        console.log(element);
        if (element.classList.contains('is-active')) {
          this.temporaryTags.splice(this.temporaryTags.indexOf(element.getAttribute('data-tag')), 1); // Delete the tag if already active
        } else {
          var activeSibling = element.closest('.collection-filters__tags').querySelector('.is-active');
    ...
    },
    {
      ...
      value: function _attachListeners() {
        ...
        this._clearTagListener = this._clearTag.bind(this);
        this._applyTagsListener = this._applyTags.bind(this);
        this._resetTagsListener = this._resetTags.bind(this);
        this._changeLayoutModeListener = this._changeLayoutMode.bind(this);

        this.delegateElement.on('click', '[data-action="toggle-tag"]', this._toggleTagListener);
        this.delegateElement.on('click', '[data-action="clear-tag"]', this._clearTagListener);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_4__components_ProductVariants__ = __webpack_require__(11);
  ...
  var FeaturedCollectionsSection = function () {
    function FeaturedCollectionsSection(container) {
      ...
      this.products.forEach(function(product) {
        var options = JSON.parse(product.getAttribute('data-section-settings'));
        if (options['templateSuffix'] !== 'coming-soon') {
          product.productVariants = new __WEBPACK_IMPORTED_MODULE_4__components_ProductVariants__["default"](product, options);
        }
      })
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_1__components_ProductItemColorSwatch__ = __webpack_require__(4);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__helper_Currency__ = __webpack_require__(5);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_3__components_ProductVariants__ = __webpack_require__(11);
      ...
      value: function _fetchProducts() {
        ...
        fetch('/search?view=recently-viewed-products&type=product&q=' + queryString, {
          ...
          response.text().then(function (content) {
            ...
            _this54.products = this.element.querySelectorAll('.ProductItem');
            _this54.products.forEach(function(product) {
              var options = JSON.parse(product.getAttribute('data-section-settings'));
              if (options['templateSuffix'] !== 'coming-soon') {
                product.productVariants = new __WEBPACK_IMPORTED_MODULE_3__components_ProductVariants__["default"](product, options);
              }
            })
          });
        });
  ...
  var RelatedProductsSection = function () {
    function RelatedProductsSection(container) {
      ...
      this.products.forEach(function(product) {
        var options = JSON.parse(product.getAttribute('data-section-settings'));
        if (options['templateSuffix'] !== 'coming-soon') {
          product.productVariants = new __WEBPACK_IMPORTED_MODULE_2__components_ProductVariants__["default"](product, options);
        }
      })
      // Setup product item color swatch
      new __WEBPACK_IMPORTED_MODULE_1__components_ProductItemColorSwatch__["default"](this.element);
